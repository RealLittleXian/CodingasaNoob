...
set_property -dict { PACKAGE_PIN P5  IOSTANDARD LVCMOS33} [get_ports button_count]
set_property -dict { PACKAGE_PIN P1  IOSTANDARD LVCMOS33} [get_ports button_dec_counter]
